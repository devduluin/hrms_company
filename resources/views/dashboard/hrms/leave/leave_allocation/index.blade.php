                    ...
                    <div class="col-span-12">
                        <div class="flex flex-col gap-y-3 md:h-10 md:flex-row md:items-center">
                            ...
                            <div class="flex flex-col gap-x-3 gap-y-2 sm:flex-row md:ml-auto">
                                <x-filter></x-filter>
                                <div >
                                    <a href="{{ url('dashboard/hrms/leave/create_allocation') }}" data-tw-merge=""
                                ...
                                <div class="table gap-y-2 p-5 sm:flex-row sm:items-center">
                                    <div>
                                        ...
                                        <x-datatable id="employeeTable" :url="$apiUrl . '/employee/datatables'" method="POST" class="display">
                                            <x-slot:thead>
                                                <th data-value="holiday_name">Employee Name</th>
                                                <th data-value="from_date">Employee</th>
                                                <th data-value="to_date" data-render="getCompany">Leave Type
                                                </th>
                                            </x-slot:thead>
                                        </x-datatable>
                                    </div>
