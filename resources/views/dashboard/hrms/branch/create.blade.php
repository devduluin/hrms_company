...
@push('js')
    <script type="text/javascript">
        ...
        try {
            const response = await fetch('http://localhost:4444/api/v1/branch', {
                method: 'POST',
                headers: {
