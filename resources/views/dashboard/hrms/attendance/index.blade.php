                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                            ...
                            <div class="flex flex-col box col-span-4 rounded-[0.6rem] border border-dashed border-slate-300/80 p-5 shadow-sm md:col-span-2 xl:col-span-1">
                                ...
                                <div class="flex items-center gap-2 mt-4">
                                    ...
                                    <div class="flex items-center text-green-500 bg-green-100 rounded-full py-1 px-3 text-xs font-medium">
                                        <i data-tw-merge="" data-lucide="arrow-down" class="ml-px mr-2 h-4 w-4 stroke-[1.5] side-menu__link_icon"></i>
                                        10%
                                    </div>
                                </div>
                            ...
                            <div class="flex flex-col box col-span-4 h-fit rounded-[0.6rem] border border-dashed border-slate-300/80 p-5 shadow-sm md:col-span-2 xl:col-span-1">
                                <div class="flex col-2">
                                    ...
                                    <div class="flex flex-col gap-x-3 gap-y-2 ml-auto sm:ml-auto justify-end">
                                        <a href="{{ url('dashboard/hrms/employee/list') }}" class=" flex px-2 py-2 bg-blue-600 text-white text-center text-sm font-medium rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-800 transition duration-200 ease-in-out sm:w-full">
                                ...
                                <div class=" w-full font-medium mt-1.5 text-l">
                                    ...
                                    <div class="col-2">
                                        <div class="flex items-center gap-2 justify-content-between">
                                            <div class="flex col-2 mt-0.5 whitespace-nowrap text-xs text-slate-500 ">
                                                <i data-tw-merge="" data-lucide="calendar" class="ml-px mr-2 h-4 w-4 stroke-[1.5] side-menu__link_icon"></i>
                                                22/12/2024
                                            </div>
                                            <div class="flex col-2 mt-0.5 whitespace-nowrap text-xs text-slate-500 ">
                                                <i data-tw-merge="" data-lucide="timer" class="ml-px mr-2 h-4 w-4 stroke-[1.5] side-menu__link_icon"></i>
                                                3 jam
                                            </div>
                                        </div>
                                    </div>
