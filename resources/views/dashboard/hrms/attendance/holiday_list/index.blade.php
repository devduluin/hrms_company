        ...
        <div class="container mt-[65px]">
            <div class="flex flex-col gap-y-3 md:h-10 md:flex-row md:items-center">
                ...
                <div class="flex flex-col gap-x-3 gap-y-2 sm:flex-row md:ml-auto">
                    ...
                    <x-form.button id="new_holiday_list" label="Add New Holiday List" style="primary" icon="plus" url="{{ url('dashboard/hrms/leave/holiday_list/create') }}" ></x-button>
                </div>
            </div>
            <div class="mt-3.5  gap-x-6 gap-y-10">
                ...
                <div class="col-span-12 flex flex-col gap-y-7 xl:col-span-9">
                    <div class="box box--stacked flex flex-col p-5">
                        <x-datatable id="hilidayListTable" :url="$apiUrl.'/datatable'" method="POST" class="display small">
                            <x-slot:thead>
                            
                                <th data-value="no" width="60px">No.</th>
                                 
                                <th data-value="holiday_list_name">Holiday List name</th>
                                <th data-value="from_date">From Date</th>
                                <th data-value="to_date">To Date</th>
                                <th data-value="total_holidays">Total Holiday</th>
            ...
            if(action === 'delete'){
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        hilidayListTable.ajax.reload();
                    }
                });
            }else{
                location.href = '{{ url("/dashboard/hrms/leave/holiday_list") }}/'+action+'/'+id;
            }
