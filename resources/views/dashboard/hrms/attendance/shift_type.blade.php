                ...
                <div class="col-span-12">
                    <div class="flex flex-col mb-4 gap-y-3 md:h-10 md:flex-row md:items-center">
                        ...
                        <div class="flex flex-col gap-x-3 gap-y-2 sm:flex-row md:ml-auto">
                            <a href="{{ url('dashboard/hrms/attendance/new_shift_type') }}" data-tw-merge=""
                    ...
                    <div class="box box--stacked flex flex-col p-5">
                        <x-datatable id="applicantTable" :url="'http://apidev.duluin.com/api/v1/branch/datatable'" method="POST" class="display">
                            <x-slot:thead>
                                <th data-value="employee_name">Shift</th>
                                <th data-value="company">Start Time</th>
                                <th data-value="shift">End Time</th>
