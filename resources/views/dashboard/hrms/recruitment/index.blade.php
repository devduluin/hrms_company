                    ...
                    <div class="mt-3.5 flex flex-col gap-8">
                        <div class="box box--stacked flex flex-col p-5">
                            <div class="grid grid-cols-4 gap-5">
                                <x-kpi_card  label="Job Opening" amount="457,204" icon="arrow-down" percentage="3%" period="this month" />
                                <x-kpi_card  label="Total Applicant" amount="457,204" icon="arrow-down" percentage="3%" period="this month" />
                                <x-kpi_card  label="Approve Applicant" amount="457,204" icon="arrow-down" percentage="3%" period="this month" /> 
                                <x-kpi_card  label="Reject Applicant" amount="457,204" icon="arrow-down" percentage="3%" period="this month" /> 
                            </div>
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <x-chart.donut label="Job Offer Status" option1="This Month" option2="Last Month" />
                            <x-chart.line  label="Job Application Frequency" option1="This Month" option2="Last Month" />
                        </div>
                        <div class="flex col-2 md:h-10 md:flex-row md:items-center">
                                ...
                                <a href="{{ url('/dashboard/hrms/recruitment/create_applicant') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                ...
                                <div class="table gap-y-2 p-5 sm:flex-row sm:items-center">
                                    <div class="overflow-auto xl:overflow-visible">
                                        <x-datatable id="employeeTable" :url="$apiUrl . '/employee/datatables" method="POST" class="display">
                                            <x-slot:thead>
                                                <th data-value="applicant_name"  data-render="getName">Applicant Name</th>
                                                <th data-value="designation">Designation</th>
                                                <th data-value="time_out">Phone Number</th>
