    ...
    <div class="content transition-[margin,width] duration-100 px-5 pt-[56px] pb-16 relative z-20 content--compact xl:ml-[275px] [&amp;.content--compact]:xl:ml-[91px]">
        <div class="mt-[65px] col-span-12 w-full">
            <div class="flex flex-col gap-y-3 md:h-10 md:flex-row md:items-center">
                        ...
                        <div data-transition="" data-selector=".show" data-enter="transition-all ease-linear duration-150" data-enter-from="absolute !mt-5 invisible opacity-0 translate-y-1" data-enter-to="!mt-1 visible opacity-100 translate-y-0" data-leave="transition-all ease-linear duration-150" data-leave-from="!mt-1 visible opacity-100 translate-y-0" data-leave-to="absolute !mt-5 invisible opacity-0 translate-y-1" class="dropdown-menu absolute z-[9999] hidden">
                            <div data-tw-merge="" class="dropdown-content rounded-md border-transparent bg-white p-2 shadow-[0px_3px_10px_#00000017] dark:border-transparent dark:bg-darkmode-600">
                                <div class="p-2">
                                  <form id="filterTable">
                                    <div class="mt-3">
                                        <x-form.input type="time" id="start_time" name="start_time" label="Start Time" placholder=""/>
                                        <input type="hidden" name="" value=""/>
                                    </div>
                                    <div class="mt-3">
                                        <x-form.input type="time" id="end_time" name="end_time" label="End Time" placholder=""/>
                                        <input type="hidden" name="" value=""/>     
                                    </div>
                ...
                <x-form.button id="new_shift_type" label="Add New Shift Type" style="primary" icon="plus" url="{{ url('dashboard/hrms/attendance/shift_type/create') }}" ></x-button>
                </div>
                </div>
            </div>
...
@push('js')
    <script>
        ...
        $(document).ready(function () {
            ...
            handleFilter("start_time", "start_time");
            handleFilter("end_time", "end_time");
