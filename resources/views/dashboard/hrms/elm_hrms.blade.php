    ...
    <div class="col-span-12 flex flex-col gap-y-12 2xl:col-span-12">
        ...
        <div class="box p-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5 mt-4">
                ...
                <x-action  label="Add Travel Request" icon="plus" url="{{ url('/dashboard/hrms/claim/travel_request') }}" />
                <x-action  label="New Shift Assignment" icon="plus" url="{{ url('/dashboard/hrms/attendance/shift_assignment') }}" />
                <x-action  label="Create Salary Slip" icon="plus" url="{{ url('/dashboard/hrms/payout/salary_slip') }}" />
