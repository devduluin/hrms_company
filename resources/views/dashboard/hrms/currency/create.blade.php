        ...
        <div class="container mt-[65px]">
            <div class="flex flex-col gap-y-3 md:h-10 md:flex-row md:items-center">
                ...
                <div class="flex flex-col gap-x-3 gap-y-2 sm:flex-row md:ml-auto">
                    <a href="{{ route('hrms.currency') }}" data-tw-merge="" class="transition duration-200 border shadow-sm inline-flex items-center justify-center py-2 px-3 rounded-md font-medium cursor-pointer focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus-visible:outline-none dark:focus:ring-slate-700 dark:focus:ring-opacity-50 [&:hover:not(:disabled)]:bg-opacity-90 [&:hover:not(:disabled)]:border-opacity-90 [&:not(button)]:text-center disabled:opacity-70 disabled:cursor-not-allowed bg-primary border-primary text-white dark:border-primary group-[.mode--light]:!border-transparent group-[.mode--light]:!bg-white/[0.12] group-[.mode--light]:!text-slate-200"><i data-tw-merge="" data-lucide="arrow-left" class="stroke-[1] w-5 h-5 mx-auto block"></i>
                        back</a>
                </div>
            </div>
                ...
                <div class="col-span-12 flex flex-col gap-y-7 xl:col-span-9">
                    <form id="form-submit">
                        <div class="box box--stacked flex flex-col p-5">
                            <div>
                                <x-form._input id="currency_name" name="currency_name" label="Currency name" required="true" placholder="Indonesian rupiah"/>
                                <x-form._input id="fraction" name="fraction" label="Fraction" type="text" required="true" placholder="IDR"/>
                                <x-form._input id="fraction_units" name="fraction_units" label="Fraction units" type="number" required="true" placholder="example 100"/>
                                <x-form._input id="symbol" name="symbol" label="Symbol" type="text" required="true" placholder="Rp"/>
                            </div>
...
@push('js')
    <script type="text/javascript">
        ...
        const data = {
            ...
            fraction_units: formData.get('fraction_units'),
