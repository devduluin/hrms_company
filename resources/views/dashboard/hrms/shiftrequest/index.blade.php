    ...
    <div class="content transition-[margin,width] duration-100 px-5 pt-[56px] pb-16 relative z-20 content--compact xl:ml-[275px] [&amp;.content--compact]:xl:ml-[91px]">
        <div class="container mt-[65px]">
            <div class="flex flex-col gap-y-3 md:h-10 md:flex-row md:items-center">
                ...
                <x-form.button id="new_shift_req" label="Add New Shift Request" style="primary" icon="plus" url="{{ route('hrms.attendance.shiftrequest.create') }}" ></x-button>
                </div>
                </div>
            </div>
            <div class="mt-3.5 gap-x-6 gap-y-10">
                ...
                <div class="col-span-12 flex flex-col gap-y-7 xl:col-span-9">
                    <div class="box box--stacked flex flex-col p-5">
                        <x-datatable id="shiftTable" :url="$apiUrl.'/datatable'" method="POST" class="display">
                            <x-slot:thead>
                                <th data-value="no" width="60px">#</th>
                                <th data-value="company_id_rel" data-render="getCompany">Company</th>
                                <th data-value="approve_type">Department</th>
                                <th data-value="employee_id_rel" data-render="getEmployee">Approver Name</th>
    ...
    <script>
        ...
        function action(action, id){
            if(action === 'delete'){
                ...
                location.href = '{{ url("/dashboard/hrms/shift-request-approver") }}/'+action+'/'+id;
            }
