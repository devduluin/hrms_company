            ...
            <div class="mt-3.5 grid grid-cols-12 gap-x-6 gap-y-10">
                ...
                <div class="col-span-12 flex flex-col gap-y-7 sm:col-span-12 xl:col-span-12">
                    <form id="form-submit" method="post" action="{{ $apiUrl }}">
                        <input type="hidden" name="approve_type" value="shift_request" />
                        <div class="box box--stacked flex flex-col p-5">
                            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2 gap-5 mt-4">
                                ...
                                <div class="gap-x-6 gap-y-10 ">
                                    ...
                                    <div class="py-2 ">
                                    <x-form.select id="department_id" name="department_id" data-method="POST" label="Department Name" url="{{ url('dashboard/hrms/department/create') }}" required="true"
                                ...
                                <div class="gap-x-6 gap-y-10">
                                    <div class="py-2 ">
                                    <x-form.select id="employee_id" name="employee_id" data-method="POST" label="Approval Name" url="{{ url('dashboard/hrms/employee/new_employee') }}" required="true"
                                        apiUrl="{{ $apiEmployeeUrl }}" columns='["first_name"]'  
                                        :keys="[
                                            'company_id' => $company,
                                        ]">
