            ...
            <div class="mt-3.5  gap-x-6 gap-y-10">
                ...
                <div class="col-span-12 flex flex-col gap-y-7 xl:col-span-9">
                    <div class="box box--stacked flex flex-col p-5">
                        <x-datatable id="branchTable" :url="$apiUrl.'/datatable'" method="GET" class="display small">
                            <x-slot:thead>
                                <th data-value="no" width="80px">#</th>
                                <th data-value="company_id_rel" data-render="getCompany">Fullname</th>
                                <th data-value="branch_name">Phone Number</th>
                                <th data-value="createdAt" data-render="dateFormat">Email</th>
                                <th data-value="createdAt" data-render="dateFormat">Last Login</th>
