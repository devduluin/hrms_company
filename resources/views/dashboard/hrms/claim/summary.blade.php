                                    ...
                                    <td data-tw-merge=""
                                        ...
                                        <div class="w-40">
                                            ...
                                            <div class="mt-1.5 flex h-1 rounded-sm border bg-slate-50">
                                                <div
                                                    class="first:rounded-l-sm last:rounded-r-sm border border-primary/20 -m-px bg-primary/40 w-[55%]">
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr data-tw-merge="" class="[&_td]:last:border-b-0">
                                    ...
                                    <td data-tw-merge=""
                                        ...
                                        <div class="w-40">
                                            ...
                                            <div class="mt-1.5 flex h-1 rounded-sm border bg-slate-50">
                                                <div
                                                    class="first:rounded-l-sm last:rounded-r-sm border border-primary/20 -m-px bg-primary/40 w-[75%]">
                                                </div>
                                            </div>
                                        </div>
                                    </td>
