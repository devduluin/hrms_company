        ...
        <div class="container mt-[65px]">
            <div class="flex flex-col gap-y-3 md:h-10 md:flex-row md:items-center">
                ...
                <div class="flex flex-col gap-x-3 gap-y-2 sm:flex-row md:ml-auto">
                    ...
                    <x-form.button id="new_expense" label="Add New Purpose Travel" style="primary" icon="plus" url="{{ url('/dashboard/hrms/claim/purpose_travel/create') }}" ></x-button>
                </div>
            </div>
                    ...
                    <div class="box box--stacked flex flex-col p-5">
                        <x-datatable id="departmentTable" :url="$apiUrl.'/datatables'" method="POST" class="display small">
                            <x-slot:thead>
                                ...
                                <th data-value="expense_title">Purpose Travel</th>
