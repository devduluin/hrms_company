        ...
        <div class="container mt-[65px]">
            <div class="flex flex-col gap-y-3 md:h-10 md:flex-row md:items-center">
                ...
                <div class="flex flex-col gap-x-3 gap-y-2 sm:flex-row md:ml-auto">
                    ...
                    <x-form.button id="new_expense" label="Add New Travel" style="primary" icon="plus" url="{{ url('/dashboard/hrms/claim/travel/create') }}" ></x-button>
                </div>
            </div>
                    ...
                    <div class="box box--stacked flex flex-col p-5">
                        <x-datatable id="departmentTable" :url="$apiUrl.'/datatables'" method="POST" class="display small">
                            <x-slot:thead>
                                ...
                                <th data-value="expense_title">Travel Purpose</th>
                                <th data-value="employee_rel_id" data-render="getDepartment">Travel Type</th>
                                <th data-value="total_amount" data-render="getDepartment">Total Amount</th>
