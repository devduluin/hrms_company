    ...
    <div class="col-span-12">
        <div class="mt-3.5 flex flex-col gap-8">
                    ...
                    <div class="box col-span-4 rounded-[0.6rem] border border-dashed border-slate-300/80 p-5 shadow-sm md:col-span-2 xl:col-span-1">
                        ...
                        <div class="col-2">
                            <div class="flex justify-end gap-2">
                                <div class="mt-2 w-10 items-left rounded-full border border-danger/10 bg-danger/10 py-[2px] pl-[7px] pr-8 text-xs font-medium text-danger">
                                    <i data-tw-merge="" data-lucide="arrow-down" class="ml-px h-4 w-4 stroke-[1.5] side-menu__link_icon"></i>
                                    3%
                                </div>
                ...
                <div class="box col-span-4 rounded-[0.6rem] border border-dashed border-slate-300/80 p-5 shadow-sm md:col-span-2 xl:col-span-1">
                    <div class="flex flex-col gap-y-3 md:h-10 md:flex-row md:items-center">
                            ...
                            <div class="flex flex-col gap-x-3 gap-y-2 sm:flex-row sm:ml-auto">
                                <a href="{{ url('dashboard/hrms/new_employee/employee_overview') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-800 transition duration-200 ease-in-out w-full sm:w-auto">
                    ...
                    <div class="flex flex-col sm:flex-row justify-between items-center gap-10 pt-4">
                    ...
                    <hr class="divider">
                    <div class=" flex flex-column flex-sm-row align-items-sm-center justify-content-between gap-10 py-3">
                        <div class=" w-full font-medium mt-1.5 text-l">
                            <a class="whitespace-nowrap font-medium" href="#">
                                Meryl Streep
                            </a>
            ...
            <div class="flex flex-col gap-y-3 md:h-10 md:flex-row md:items-center">
                    ...
                    <a href="{{ url('/dashboard/hrms/new_job_applicant') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                        <!-- Icon (example using Heroicons) -->
                        <svg class="w-5 h-5 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                        </svg>
                            ...
                            <tr data-tw-merge="" class="[&_td]:last:border-b-0">
                                ...
                                <td data-tw-merge="" class="px-5 border-b dark:border-darkmode-300 relative border-dashed py-4 dark:bg-darkmode-600">
                                    <div class="flex space-x-2">
                                        <a href="{{ url('dashboard/hrms/new_job_applicant') }}" class="flex items-center p-2 bg-blue-600 text-white text-sm font-medium rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                            <!-- Icon Edit (Pencil) -->
                                            <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5.586l6.707 6.707-7.778 7.778L3.222 13.364l7.778-7.778zM18.364 7.05l1.415 1.415a1 1 0 0 1 0 1.415l-7.778 7.778-2.121-.707.707-2.121 7.778-7.778a1 1 0 0 1 1.415 0z" />
                                            </svg>
                                        </a>
                                        <a class="cursor-pointer flex items-center p-2 transition duration-300 ease-in-out rounded-md hover:bg-slate-200/60 dark:bg-darkmode-600 dark:hover:bg-darkmode-400 dropdown-item text-danger">
                                            <!-- Icon Delete (Trash) -->
                                            <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H6zM8 11v5m4-5v5m4-5v5m1-7h-9m9 0h-9m1-7h5m-5 0h5" />
                                            </svg>
                                        </a>
                                    </div>
                                </td>
