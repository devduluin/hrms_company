                            ...
                            <div class="flex flex-col gap-x-3 gap-y-2 sm:flex-row md:ml-auto">
                                <div class="relative">
                                    <i data-tw-merge="" data-lucide="calendar-check2"
                                        class="absolute inset-y-0 left-0 z-10 my-auto ml-3 h-4 w-4 stroke-[1.3] group-[.mode--light]:!text-slate-200"></i>
                                ...
                                <div
                                    ...
                                    <div data-config="fade" class="tiny-slider">
                                        <div class="px-1">
                                            <div
                                                ...
                                                <i data-tw-merge="" data-lucide="medal"
                                                    class="absolute right-0 top-0 -mr-5 -mt-5 h-36 w-36 rotate-[-10deg] transform fill-white/[0.03] stroke-[0.3] text-white/20"></i>
                                                ...
                                                <a class="flex items-center font-medium text-white" href="#">
                                                    Upgrade now
                                                    <i data-tw-merge="" data-lucide="move-right"
                                                        class="stroke-[1] ml-1.5 h-4 w-4"></i>
                                                </a>
                                            </div>
                                        </div>
                                        <div class="px-1">
                                        ...
                                        <div class="px-1">
                                            <div
                                                class="relative flex h-full w-full flex-col overflow-hidden rounded-[0.5rem] bg-gradient-to-b from-theme-2/90 to-theme-1/90 p-5">
                                                <i data-tw-merge="" data-lucide="gauge"
                                                    class="absolute right-0 top-0 -mr-5 -mt-5 h-36 w-36 rotate-[-10deg] transform fill-white/[0.03] stroke-[0.3] text-white/20"></i>
                                                <div class="mb-9 mt-12">
                                                    <div class="text-2xl font-medium leading-snug text-white">
                                                        Supercharge
                            ...
                            <div class="box box--stacked col-span-12 flex flex-col p-5 md:col-span-6 2xl:col-span-3">
                                <div data-tw-merge="" data-tw-placement="bottom-end"
                                    class="dropdown absolute right-0 top-0 mr-5 mt-5"><button data-tw-toggle="dropdown"
                                        aria-expanded="false" class="cursor-pointer h-5 w-5 text-slate-500"><i
                                ...
                                <div class="relative mb-6 mt-5 overflow-hidden">
                                    ...
                                    <div class="w-auto h-[100px]">
                                        <canvas data-index="2" data-border-color="primary"
                                            data-background-color="primary/0.3"
                                            class="chart report-line-chart relative z-10 -ml-1.5"></canvas>
                                    </div>
                                </div>
                            ...
                            <div class="box box--stacked col-span-12 flex flex-col p-5 md:col-span-6 2xl:col-span-3">
                                ...
                                <div class="flex items-center">
                                    <div
                                        ...
                                        <i data-tw-merge="" data-lucide="files"
                                ...
                                <div class="relative mb-6 mt-5 overflow-hidden">
                                    ...
                                    <div class="w-auto h-[100px]">
                                        <canvas data-index="0" data-border-color="success"
                            ...
                            <div data-config="performance-insight-slider-config" class="tiny-slider">
                                <div class="px-2.5 pb-3">
                                    <div class="box box--stacked relative p-5">
                                        ...
                                        <a class="mt-4 flex items-center border-t border-dashed pt-4 font-medium text-primary"
                                            href="#">
                                            Explore Products
                                            <i data-tw-merge="" data-lucide="arrow-right"
                                                class="stroke-[1] ml-1.5 h-4 w-4"></i>
                                ...
                                <tbody>
                                    <tr data-tw-merge="" class="">
                                        <td data-tw-merge=""
                                            ...
                                            <div class="flex items-center">
                                                <i data-tw-merge="" data-lucide="cookie"
                                        ...
                                        <td data-tw-merge=""
                                            class="px-5 py-3 border-b dark:border-darkmode-300 box w-60 rounded-l-none rounded-r-none border-x-0 shadow-[5px_3px_5px_#00000005] first:rounded-l-[0.6rem] first:border-l last:rounded-r-[0.6rem] last:border-r dark:bg-darkmode-600">
                                        ...
                                        <td data-tw-merge=""
                                            class="px-5 py-3 border-b dark:border-darkmode-300 box w-44 rounded-l-none rounded-r-none border-x-0 shadow-[5px_3px_5px_#00000005] first:rounded-l-[0.6rem] first:border-l last:rounded-r-[0.6rem] last:border-r dark:bg-darkmode-600">
                                        ...
                                        <td data-tw-merge=""
                                            class="px-5 border-b dark:border-darkmode-300 box relative w-20 rounded-l-none rounded-r-none border-x-0 py-0 shadow-[5px_3px_5px_#00000005] first:rounded-l-[0.6rem] first:border-l last:rounded-r-[0.6rem] last:border-r dark:bg-darkmode-600">
                                                ...
                                                <div data-tw-merge="" data-tw-placement="bottom-end"
                                                    ...
                                                    <div data-transition="" data-selector=".show"
                                                        ...
                                                        <div data-tw-merge=""
                                                            ...
                                                            <a
                                                                class="cursor-pointer flex items-center p-2 transition duration-300 ease-in-out rounded-md hover:bg-slate-200/60 dark:bg-darkmode-600 dark:hover:bg-darkmode-400 dropdown-item"><i
                                                                    data-tw-merge="" data-lucide="file-signature"
                                                                    class="stroke-[1] mr-2 h-4 w-4"></i>
                                                                Edit Order</a>
                                                            <a
                                                                class="cursor-pointer flex items-center p-2 transition duration-300 ease-in-out rounded-md hover:bg-slate-200/60 dark:bg-darkmode-600 dark:hover:bg-darkmode-400 dropdown-item"><i
                                    ...
                                    <tr data-tw-merge="" class="">
                                        <td data-tw-merge=""
                                            class="px-5 py-3 border-b dark:border-darkmode-300 box rounded-l-none rounded-r-none border-x-0 shadow-[5px_3px_5px_#00000005] first:rounded-l-[0.6rem] first:border-l last:rounded-r-[0.6rem] last:border-r dark:bg-darkmode-600">
                                            <div class="flex items-center">
                                                <i data-tw-merge="" data-lucide="venetian-mask"
                                                    class="h-6 w-6 fill-primary/10 stroke-[0.8] text-theme-1"></i>
                                                <div class="ml-3.5">
                                                    <a class="whitespace-nowrap font-medium" href="#">
                                    ...
                                    <tr data-tw-merge="" class="">
                                        <td data-tw-merge=""
                                            class="px-5 py-3 border-b dark:border-darkmode-300 box rounded-l-none rounded-r-none border-x-0 shadow-[5px_3px_5px_#00000005] first:rounded-l-[0.6rem] first:border-l last:rounded-r-[0.6rem] last:border-r dark:bg-darkmode-600">
                                            <div class="flex items-center">
                                                <i data-tw-merge="" data-lucide="trophy"
                                                    class="h-6 w-6 fill-primary/10 stroke-[0.8] text-theme-1"></i>
                                                <div class="ml-3.5">
                                                    <a class="whitespace-nowrap font-medium" href="#">
