<div class="box box--stacked flex flex-col p-5">
    ...
    <div>
        <div role="alert" class="alert relative border rounded-md px-5 py-4 border-primary text-primary dark:border-primary mb-2 flex items-center border-primary/20 bg-primary/5 px-4">
            <div>
                <i data-tw-merge="" data-lucide="alert-circle" class="mr-3 h-4 w-4 stroke-[1.3] md:mr-2"></i>
            </div>
            <div class="mr-5 leading-relaxed">
                ...
                <button data-tw-merge="" data-tw-dismiss="alert" type="button" aria-label="Close" class="text-slate-800 py-2 px-3 absolute right-0 my-auto mr-2 btn-close inset-y-0"><i data-tw-merge="" data-lucide="x" class="stroke-[1] h-4 w-4"></i></button>
            </div>
        </div>
                ...
                <table data-tw-merge="" class="w-full text-left">
                    <thead data-tw-merge="" class="">
                        <tr data-tw-merge="" class="">
                            <td data-tw-merge="" class="px-5 border-b dark:border-darkmode-300 border-slate-200/80 bg-slate-50 py-4 font-medium text-slate-500 first:rounded-tl-lg last:rounded-tr-lg">
                                Type
                            </td>
                            <td data-tw-merge="" class="px-5 border-b dark:border-darkmode-300 border-slate-200/80 bg-slate-50 py-4 font-medium text-slate-500 first:rounded-tl-lg last:rounded-tr-lg">
                                <div class="flex flex-col items-center">
                                    <i data-tw-merge="" data-lucide="mail-check" class="stroke-[1] h-6 w-6"></i>
                                    <div class="mt-1.5">Email</div>
                                </div>
                            </td>
                            <td data-tw-merge="" class="px-5 border-b dark:border-darkmode-300 border-slate-200/80 bg-slate-50 py-4 font-medium text-slate-500 first:rounded-tl-lg last:rounded-tr-lg">
                                <div class="flex flex-col items-center">
                                    <i data-tw-merge="" data-lucide="globe" class="stroke-[1] h-6 w-6"></i>
                                    <div class="mt-1.5">Browser</div>
                                </div>
                            </td>
                            <td data-tw-merge="" class="px-5 border-b dark:border-darkmode-300 border-slate-200/80 bg-slate-50 py-4 font-medium text-slate-500 first:rounded-tl-lg last:rounded-tr-lg">
                                <div class="flex flex-col items-center">
                                    <i data-tw-merge="" data-lucide="smartphone" class="stroke-[1] h-6 w-6"></i>
                    ...
                    <tbody>
                        <tr data-tw-merge="" class="[&_td]:last:border-b-0">
                            <td data-tw-merge="" class="px-5 border-b dark:border-darkmode-300 border-dashed border-slate-300/70 py-4 dark:bg-darkmode-600">
                        ...
                        <tr data-tw-merge="" class="[&_td]:last:border-b-0">
                            <td data-tw-merge="" class="px-5 border-b dark:border-darkmode-300 border-dashed border-slate-300/70 py-4 dark:bg-darkmode-600">
                                <div class="flex items-center whitespace-nowrap">
                                    ...
                                    <i data-tw-merge="" data-lucide="info" class="ml-1.5 h-4 w-4 stroke-[1.3] text-slate-400"></i>
                                </div>
                            </td>
                            <td data-tw-merge="" class="px-5 border-b dark:border-darkmode-300 border-dashed border-slate-300/70 py-4 dark:bg-darkmode-600">
                                <div class="text-center">
                            ...
                            <td data-tw-merge="" class="px-5 border-b dark:border-darkmode-300 border-dashed border-slate-300/70 py-4 dark:bg-darkmode-600">
                                <div class="text-center">
                                    <input data-tw-merge="" type="checkbox" class="transition-all duration-100 ease-in-out shadow-sm border-slate-200 cursor-pointer rounded focus:ring-4 focus:ring-offset-0 focus:ring-primary focus:ring-opacity-20 dark:bg-darkmode-800 dark:border-transparent dark:focus:ring-slate-700 dark:focus:ring-opacity-50 [&[type='radio']]:checked:bg-primary [&[type='radio']]:checked:border-primary [&[type='radio']]:checked:border-opacity-10 [&[type='checkbox']]:checked:bg-primary [&[type='checkbox']]:checked:border-primary [&[type='checkbox']]:checked:border-opacity-10 [&:disabled:not(:checked)]:bg-slate-100 [&:disabled:not(:checked)]:cursor-not-allowed [&:disabled:not(:checked)]:dark:bg-darkmode-800/50 [&:disabled:checked]:opacity-70 [&:disabled:checked]:cursor-not-allowed [&:disabled:checked]:dark:bg-darkmode-800/50" id="checkbox-switch-8" value="">
                                </div>
                            </td>
                        </tr>
                        <tr data-tw-merge="" class="[&_td]:last:border-b-0">
                            ...
                            <td data-tw-merge="" class="px-5 border-b dark:border-darkmode-300 border-dashed border-slate-300/70 py-4 dark:bg-darkmode-600">
                                <div class="text-center">
                                    <input data-tw-merge="" type="checkbox" class="transition-all duration-100 ease-in-out shadow-sm border-slate-200 cursor-pointer rounded focus:ring-4 focus:ring-offset-0 focus:ring-primary focus:ring-opacity-20 dark:bg-darkmode-800 dark:border-transparent dark:focus:ring-slate-700 dark:focus:ring-opacity-50 [&[type='radio']]:checked:bg-primary [&[type='radio']]:checked:border-primary [&[type='radio']]:checked:border-opacity-10 [&[type='checkbox']]:checked:bg-primary [&[type='checkbox']]:checked:border-primary [&[type='checkbox']]:checked:border-opacity-10 [&:disabled:not(:checked)]:bg-slate-100 [&:disabled:not(:checked)]:cursor-not-allowed [&:disabled:not(:checked)]:dark:bg-darkmode-800/50 [&:disabled:checked]:opacity-70 [&:disabled:checked]:cursor-not-allowed [&:disabled:checked]:dark:bg-darkmode-800/50" id="checkbox-switch-11" value="">
                                </div>
                            </td>
                        </tr>
                        <tr data-tw-merge="" class="[&_td]:last:border-b-0">
                            ...
                            <td data-tw-merge="" class="px-5 border-b dark:border-darkmode-300 border-dashed border-slate-300/70 py-4 dark:bg-darkmode-600">
                                <div class="text-center">
                                    <input data-tw-merge="" type="checkbox" class="transition-all duration-100 ease-in-out shadow-sm border-slate-200 cursor-pointer rounded focus:ring-4 focus:ring-offset-0 focus:ring-primary focus:ring-opacity-20 dark:bg-darkmode-800 dark:border-transparent dark:focus:ring-slate-700 dark:focus:ring-opacity-50 [&[type='radio']]:checked:bg-primary [&[type='radio']]:checked:border-primary [&[type='radio']]:checked:border-opacity-10 [&[type='checkbox']]:checked:bg-primary [&[type='checkbox']]:checked:border-primary [&[type='checkbox']]:checked:border-opacity-10 [&:disabled:not(:checked)]:bg-slate-100 [&:disabled:not(:checked)]:cursor-not-allowed [&:disabled:not(:checked)]:dark:bg-darkmode-800/50 [&:disabled:checked]:opacity-70 [&:disabled:checked]:cursor-not-allowed [&:disabled:checked]:dark:bg-darkmode-800/50" id="checkbox-switch-14" value="">
                                </div>
                            </td>
                        </tr>
                        <tr data-tw-merge="" class="[&_td]:last:border-b-0">
                            ...
                            <td data-tw-merge="" class="px-5 border-b dark:border-darkmode-300 border-dashed border-slate-300/70 py-4 dark:bg-darkmode-600">
                                <div class="text-center">
                                    <input data-tw-merge="" type="checkbox" class="transition-all duration-100 ease-in-out shadow-sm border-slate-200 cursor-pointer rounded focus:ring-4 focus:ring-offset-0 focus:ring-primary focus:ring-opacity-20 dark:bg-darkmode-800 dark:border-transparent dark:focus:ring-slate-700 dark:focus:ring-opacity-50 [&[type='radio']]:checked:bg-primary [&[type='radio']]:checked:border-primary [&[type='radio']]:checked:border-opacity-10 [&[type='checkbox']]:checked:bg-primary [&[type='checkbox']]:checked:border-primary [&[type='checkbox']]:checked:border-opacity-10 [&:disabled:not(:checked)]:bg-slate-100 [&:disabled:not(:checked)]:cursor-not-allowed [&:disabled:not(:checked)]:dark:bg-darkmode-800/50 [&:disabled:checked]:opacity-70 [&:disabled:checked]:cursor-not-allowed [&:disabled:checked]:dark:bg-darkmode-800/50" id="checkbox-switch-17" value="">
                                </div>
                            </td>
                        </tr>
                    </tbody>
