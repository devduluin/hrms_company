            ...
            <div class="mt-[45px] col-span-12 w-full">
                ...
                <div class="grid grid-cols-12 gap-x-6 gap-y-10">
                    <div class="col-span-12">
                        ...
                        <div class="flex flex-col gap-x-3 gap-y-2 sm:flex-row md:ml-auto">
                            <x-form.button id="new_salaryslip" label="Add Salary Slip" style="primary" icon="plus" url="{{ url('dashboard/hrms/payout/salary_slip/create') }}"></x-button>
                            <!-- <a href="{{ url('dashboard/hrms/payout/salary_slip/create') }}" data-tw-merge=""
...
@push('js')
    <script>
        ...
        function getStatus(data, type, row, meta) {
            ...
            } else if (row.status == 'paid' || row.status == 'approved') {
                return `<div class="flex items-center justify-center text-success"><div class="ml-1.5 whitespace-nowrap">${row.status.toUpperCase()}</div></div>`;
            } else {
                return `<div class="flex items-center justify-center text-dabger"><div class="ml-1.5 whitespace-nowrap">${row.status.toUpperCase()}</div></div>`;
            }
        }
        ...
        function action(action, id){
            if(action === 'delete'){
                ...
                location.href = '{{ url("dashboard/hrms/payout/salary_slip/edit") }}/'+id;
            }
        }
