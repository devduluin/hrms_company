                ...
                <div class="col-span-12">
                    <div class="flex flex-col mb-4 gap-y-3 md:h-10 md:flex-row md:items-center">
                        <div class="text-base font-medium group-[.mode--light]:text-white">
                            Employee Benefit Claim List
                        </div>
                        <div class="flex flex-col gap-x-3 gap-y-2 sm:flex-row md:ml-auto">
                            <x-form.button label="New Employee Benefit Claim" id="overview-btn" style="primary" type="button" icon="plus"/>
                        </div>
                    </div>  
                    ...
                    <div class="box box--stacked flex flex-col p-5">
                        <x-datatable id="applicantTable" :url="'http://localhost:4444/api/v1/branch/datatable'" method="POST" class="display">
                            <x-slot:thead>
                                ...
                                <th data-value="claim_date">Claim Date</th>
                                <th data-value="claim_amount" >Claim Amount</th>
                            </x-slot:thead>
                        </x-datatable>
                    </div>  
                </div>
