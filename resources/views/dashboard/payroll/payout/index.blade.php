                        ...
                        <div class="mt-3.5 flex flex-col gap-8">
                            <div class="box box--stacked flex flex-col p-5">
                                <div class="grid grid-cols-4 gap-5">
                                    <x-kpi_card label="Total Declaration Submitted" amount="457,204" icon="arrow-down"
                                        percentage="3%" period="this month" />
                                    <x-kpi_card label="Total Salary Structure" amount="122,721" icon="arrow-down"
                                        percentage="3%" period="this month" />
                                    <x-kpi_card label="Total Incentive Given" amount="489,223" icon="arrow-down"
                                        percentage="3%" period="this month" />
                                    <x-kpi_card label="Total Outgoing Salary" amount="489,223" icon="arrow-down"
                                        percentage="3%" period="this month" />
                                </div>
                            </div>
