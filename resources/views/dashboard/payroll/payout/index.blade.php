                                ...
                                <div class="flex flex-col gap-y-5 lg:flex-row lg:items-center">
                                    <div class="flex flex-col gap-x-3 gap-y-2 sm:flex-row sm:items-center">
                                        <div class="relative">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                ...
                                                stroke-linecap="round" stroke-linejoin="round" data-lucide="calendar-check2"
                                                class="lucide lucide-calendar-check2 absolute inset-y-0 left-0 z-10 my-auto ml-3 h-4 w-4 stroke-[1.3]">
                                        ...
                                        <div class="relative">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                ...
                                                class="lucide lucide-calendar absolute inset-y-0 left-0 z-10 my-auto ml-3 h-4 w-4 stroke-[1.3]">
                                    ...
                                    <div class="flex items-center gap-3.5 lg:ml-auto">
                                        <a class="flex items-center text-slate-500" href="#">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round" data-lucide="printer"
                                                class="lucide lucide-printer h-3.5 w-3.5 stroke-[1.7]">
                                        ...
                                        <a class="flex items-center text-primary" href="#">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round" data-lucide="external-link"
                                    ...
                                    <div class="flex flex-col md:flex-row">
                                        <div
                                            ...
                                            <div class="flex-start flex flex-col">
                                                <div class="text-slate-500">Total Salary Structure</div>
                                        ...
                                        <div
                                            ...
                                            <div class="flex-start flex flex-col">
                                                <div class="text-slate-500">Total Outgoing Salary</div>
                                                <div class="mt-1.5 flex items-center">
                                                    ...
                                                    <div class="-mr-1 ml-2 flex items-center text-xs text-success">
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                            ...
                                                            stroke-linejoin="round" data-lucide="chevron-up"
                                                            class="lucide lucide-chevron-up stroke-[1] ml-px h-4 w-4">
                                        ...
                                        <div
                                            ...
                                            <div class="flex-start flex flex-col">
                                                <div class="text-slate-500">Total Payslip</div>
                                                <div class="mt-1.5 flex items-center">
                                                    ...
                                                    <div class="-mr-1 ml-2 flex items-center text-xs text-danger">
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                            ...
                                                            class="lucide lucide-chevron-down stroke-[1] ml-px h-4 w-4">
