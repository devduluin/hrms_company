                    ...
                    <div class="col-span-12">
                        <div class="flex flex-col gap-y-3 md:h-10 md:flex-row md:items-center">
                            ...
                            <div class="flex flex-col gap-x-3 gap-y-2 sm:flex-row md:ml-auto">
                                <a href="{{ url('dashboard/hrms/payout/settings/create') }}" data-tw-merge=""
                            ...
                            <div class="box box--stacked flex flex-col">
                                <div class="table gap-y-2 p-5 sm:flex-row sm:items-center">
                                    <div>
                                        ...
                                        <x-datatable id="employeeTable" :url="$apiUrl . '/payroll_setting/datatables'" method="POST" class="display">
                                            <x-slot:thead>
                                                <th data-value="id" data-render="getId" orderable="true">#</th>
                                                <th data-value="company_id" data-render="getCompany" orderable="true">
                                                    Company</th>
                                                <th data-value="calculate_payroll_working_day" orderable="true">Calculate
                                                    Payroll By
                                                </th>
