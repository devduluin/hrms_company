                        ...
                        <div class="mt-3.5 flex flex-col gap-8">
                            <div class="box box--stacked flex flex-col p-4">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2 gap-5 ">
                                    <x-form.select name="salary_structure" id="salary_structure" label="Salary Structure" class="tom-select w-full"
                                        data-placeholder="Select Gender" url="{{ url('dashboard/hrms/designation') }}" required>
                                        <option value="">Select Gender</option>
                                        <option value="male">Male</option>
                                        <option value="female">Female</option>
                                    </x-form.select>
                                    <x-form.select name="company" id="company" label="Company" class="tom-select w-full"
                                        data-placeholder="Select Company" url="{{ url('dashboard/hrms/designation') }}" required>
                                        <option value="">Select Gender</option>
                                        <option value="male">Male</option>
                                        <option value="female">Female</option>
                                    </x-form.select>
                                    <x-form.datepicker id="from_date" label="From Date" name="from_date" required />
                                    <x-form.input id="payroll_payable_account" label="Payroll Payable Account" name="payroll_payable_account" />
                                    <x-form.input id="income_tax_slab" label="Income Tax Slab" name="income_tax_slab"  />
                                    <x-form.input id="currency" label="Currency" name="currency" />
                                </div>
                                ...
                                <x-shift_table id="assignShiftContainer" apiUrl="{{ $apiUrl }}" h1="Employee" h2="Name" h3="Grade" h4="Base" h5="Variable"></x-table_custom>
                            </div>
                        </div>
                    </div>
                </div>
