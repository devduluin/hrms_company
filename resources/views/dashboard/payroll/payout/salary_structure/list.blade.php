                    ...
                    <div class="col-span-12">
                        <div class="flex flex-col gap-y-3 md:h-10 md:flex-row md:items-center">
                            ...
                            <div class="flex flex-col gap-x-3 gap-y-2 sm:flex-row md:ml-auto">
                                    ...
                                    <div data-tw-merge="" class="dropdown-content rounded-md border-transparent bg-white p-2 shadow-[0px_3px_10px_#00000017] dark:border-transparent dark:bg-darkmode-600">
                                        <div class="p-2">
                                            <form method="GET" id="filterTable">
                                                <div class="mt-3">
                                                    <x-form.select style="width: 111%;" name="is_active" id="is_active" label="Status" data-method="POST">
                                ...
                                <x-form.button id="new_salaryslip" label="Add New Salary Structure" style="primary" icon="plus" url="{{ url('dashboard/hrms/payout/salary_structure/create') }}"></x-button>
