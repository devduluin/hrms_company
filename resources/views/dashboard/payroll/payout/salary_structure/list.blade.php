                        ...
                        <div class="mt-3.5 flex flex-col gap-8">
                            <div class="box box--stacked flex flex-col">
                                <div class="table gap-y-2 p-5 sm:flex-row sm:items-center">
                                    <div>
                                        <x-datatable id="employeeTable" url="http://apidev.duluin.com/api/v1/salary_structures/salary_structure/datatables" method="POST" class="display">
                                            <x-slot:thead>
...
@push('js')
    <script>
        function getActionBtn(data, type, row, meta) {
            const url = `{{ url('dashboard/hrms/payout/salary_structure/edit') }}/${data}`;
            // console.log(url);
