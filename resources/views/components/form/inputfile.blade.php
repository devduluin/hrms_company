...
<div {{ $attributes->merge(['class' => 'mt-2 flex-row xl:items-center'])->except(['id', 'label', 'name']) }}>
    <div class="inline-block sm:mr-5 sm:text-right xl:mr-4">
        <div class="text-left">
    ...
    <div class="flex-1 sm:w-full w-96 gap-1  xl:mt-0">
        <input data-tw-merge id="{{ $id }}" name="{{ $name }}" type="file"
            placeholder="{{ $label }}" accept="image/*"
