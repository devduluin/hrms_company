<div class="side-menu__content z-10 xl:ml-0 xl:z-0 fixed shadow-xl xl:shadow-none bg-white w-[275px] border-dotted border-slate-400/60 duration-300 transition-[width,margin] group-[.side-menu--collapsed]:xl:w-[100px] group-[.side-menu--collapsed.side-menu--on-hover]:xl:border-slate-50 group-[.side-menu--collapsed.side-menu--on-hover]:xl:border-solid group-[.side-menu--collapsed.side-menu--on-hover]:xl:shadow-[6px_0_12px_-4px_#0000000f] group-[.side-menu--collapsed.side-menu--on-hover]:xl:w-[275px] xl:pt-[65px] xl:pl-2.5 xl:relative overflow-hidden border-r h-screen flex flex-col before:content-[''] before:transition-colors before:w-screen before:h-screen before:absolute before:bg-texture-black before:bg-contain before:bg-fixed before:bg-[center_-20rem] before:bg-no-repeat before:bg-slate-50 group-[.side-menu--collapsed.side-menu--on-hover]:xl:before:bg-white after:content-[''] after:fixed after:inset-0 after:bg-black/80 after:z-[-1] after:xl:hidden group-[.side-menu--mobile-menu-open]:ml-0 group-[.side-menu--mobile-menu-open]:after:block -ml-[275px] after:hidden">
    ...
    <div class="scrollable-ref w-full h-full z-20 px-5 mt-3.5 overflow-y-auto overflow-x-hidden pb-3 [-webkit-mask-image:-webkit-linear-gradient(top,rgba(0,0,0,0),black_30px)] [&:-webkit-scrollbar]:w-0 [&:-webkit-scrollbar]:bg-transparent [&_.simplebar-content]:p-0 [&_.simplebar-track.simplebar-vertical]:w-[10px] [&_.simplebar-track.simplebar-vertical]:mr-0.5 [&_.simplebar-track.simplebar-vertical_.simplebar-scrollbar]:before:bg-slate-400/30">
        <ul class="scrollable">
            ...
            <li>
                <a href="hurricane-dashboard-overview-7.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-dashboard-overview-8.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-file-manager-grid.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-point-of-sale.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-chat.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-calendar.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-creative.html" class="side-menu__link ">
                    <i data-tw-merge="" data-lucide="album" class="stroke-[1] w-5 h-5 side-menu__link__icon"></i>
            ...
            <li>
                <a href="hurricane-dynamic.html" class="side-menu__link ">
                    <i data-tw-merge="" data-lucide="activity-square" class="stroke-[1] w-5 h-5 side-menu__link__icon"></i>
            ...
            <li>
                <a href="hurricane-interactive.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-users.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-departments.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-add-user.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-profile-overview.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-profile-overview-events.html" class="side-menu__link ">
                    <i data-tw-merge="" data-lucide="calendar-range" class="stroke-[1] w-5 h-5 side-menu__link__icon"></i>
            ...
            <li>
                <a href="hurricane-profile-overview-achievements.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-profile-overview-contacts.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-profile-overview-default.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-settings.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-settings-email-settings.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-settings-security.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-settings-preferences.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-settings-two-factor-authentication.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-settings-device-history.html" class="side-menu__link ">
                    <i data-tw-merge="" data-lucide="keyboard" class="stroke-[1] w-5 h-5 side-menu__link__icon"></i>
            ...
            <li>
                <a href="hurricane-settings-notification-settings.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-settings-connected-services.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-settings-social-media-links.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-settings-account-deactivation.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-billing.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-invoice.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-categories.html" class="side-menu__link ">
                    <i data-tw-merge="" data-lucide="book-marked" class="stroke-[1] w-5 h-5 side-menu__link__icon"></i>
            ...
            <li>
                <a href="hurricane-add-product.html" class="side-menu__link ">
            ...
            <li>
                ...
                <ul class="hidden">
                    <li>
                        <a href="hurricane-product-list.html" class="side-menu__link ">
                    ...
                    <li>
                        <a href="hurricane-product-grid.html" class="side-menu__link ">
                            <i data-tw-merge="" data-lucide="layout-panel-left" class="stroke-[1] w-5 h-5 side-menu__link__icon"></i>
                            <div class="side-menu__link__title">
                                Product Grid
                            </div>
            ...
            <li>
                ...
                <ul class="hidden">
                    <li>
                        <a href="hurricane-transaction-list.html" class="side-menu__link ">
                    ...
                    <li>
                        <a href="hurricane-transaction-detail.html" class="side-menu__link ">
            ...
            <li>
                ...
                <ul class="hidden">
                    <li>
                        <a href="hurricane-seller-list.html" class="side-menu__link ">
                    ...
                    <li>
                        <a href="hurricane-seller-detail.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-reviews.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-login.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-register.html" class="side-menu__link ">
            ...
            <li>
                ...
                <ul class="hidden">
                    <li>
                        <a href="hurricane-regular-table.html" class="side-menu__link ">
                            <i data-tw-merge="" data-lucide="flip-vertical" class="stroke-[1] w-5 h-5 side-menu__link__icon"></i>
                            <div class="side-menu__link__title">
                                Regular Table
                            </div>
                    ...
                    <li>
                        <a href="hurricane-tabulator.html" class="side-menu__link ">
                            <i data-tw-merge="" data-lucide="flip-horizontal" class="stroke-[1] w-5 h-5 side-menu__link__icon"></i>
                            <div class="side-menu__link__title">
                                Tabulator
                            </div>
            ...
            <li>
                ...
                <ul class="hidden">
                    <li>
                        <a href="hurricane-modal.html" class="side-menu__link ">
                    ...
                    <li>
                        <a href="hurricane-slideover.html" class="side-menu__link ">
                    ...
                    <li>
                        <a href="hurricane-notification.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-tab.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-accordion.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-button.html" class="side-menu__link ">
                    <i data-tw-merge="" data-lucide="plus-square" class="stroke-[1] w-5 h-5 side-menu__link__icon"></i>
            ...
            <li>
                <a href="hurricane-alert.html" class="side-menu__link ">
                    <i data-tw-merge="" data-lucide="presentation" class="stroke-[1] w-5 h-5 side-menu__link__icon"></i>
            ...
            <li>
                <a href="hurricane-progress-bar.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-tooltip.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-dropdown.html" class="side-menu__link ">
                    <i data-tw-merge="" data-lucide="flip-vertical" class="stroke-[1] w-5 h-5 side-menu__link__icon"></i>
            ...
            <li>
                <a href="hurricane-typography.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-icon.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-loading-icon.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-regular-form.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-datepicker.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-tom-select.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-file-upload.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-wysiwyg-editor.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-validation.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-chart.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-slider.html" class="side-menu__link ">
            ...
            <li>
                <a href="hurricane-image-zoom.html" class="side-menu__link ">
