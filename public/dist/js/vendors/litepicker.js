(() => {
    ...
    var nt = (x, k, D) => (
        ...
        it(
            k || !x || !x.__esModule
                ? V(D, "default", { value: x, enumerable: !0 })
                : D,
            x
        )
    );
    var J = et((H, W) => {
        (function (x, k) {
            typeof H == "object" && typeof W == "object"
                ? (W.exports = k())
            ...
            return (function (x) {
                ...
                function D(d) {
                    ...
                    var s = (k[d] = { i: d, l: !1, exports: {} });
                    return (
                        x[d].call(s.exports, s, s.exports, D),
                        (s.l = !0),
                        s.exports
                    );
                }
                ...
                function (x, k, D) {
                    ...
                    var d = (function () {
                        ...
                        return (
                            (s.parseDateTime = function (i, l, e) {
                                if (
                                ...
                                if (/^-?\d{10,}$/.test(i))
                                    return s.getDateZeroTime(
                                        new Date(Number(i))
                                    );
                                if (typeof i == "string") {
                                    for (
                                        var g = [], w = null;
                                        (w = s.regex.exec(l)) != null;
                                    ...
                                    if (g.length) {
                                        ...
                                        if (m.test(i)) {
                                            var p = m.exec(i),
                                                ...
                                                b = null;
                                            y.month
                                                ? (b = Number(p[y.month]) - 1)
                                                : y.shortMonth
                                                ? (b = s
                                                      .shortMonths(e)
                                                      .indexOf(p[y.shortMonth]))
                                                : y.longMonth &&
                                                  (b = s
                                                      .longMonths(e)
                                                      .indexOf(p[y.longMonth]));
                            ...
                            (s.prototype.setHours = function (i, l, e, g) {
                                i === void 0 && (i = 0),
                                    ...
                                    e === void 0 && (e = 0),
                                    g === void 0 && (g = 0),
                                    this.dateInstance.setHours(i, l, e, g);
                            }),
                            ...
                            (s.prototype.getWeek = function (i) {
                                ...
                                return (
                                    ...
                                    1 + Math.ceil((g - l.getTime()) / 6048e5)
                                );
                            }),
                            ...
                            (s.prototype.isBefore = function (i, l) {
                                switch ((l === void 0 && (l = "seconds"), l)) {
                                    ...
                                    case "years":
                                        return (
                                            i.getFullYear() > this.getFullYear()
                                        );
                                }
                            ...
                            (s.prototype.isAfter = function (i, l) {
                                switch ((l === void 0 && (l = "seconds"), l)) {
                                    ...
                                    case "years":
                                        return (
                                            this.getFullYear() > i.getFullYear()
                                        );
                                }
                            ...
                            (s.prototype.format = function (i, l) {
                                if (
                                    ...
                                    return i.output(this.clone().toJSDate());
                                for (
                                    var e = "", g = [], w = null;
                                    (w = s.regex.exec(i)) != null;

                                )
                                    w[1] !== "\\" && g.push(w);
                                if (g.length) {
                                    g[0].index > 0 &&
                                        (e += i.substring(0, g[0].index));
                                    for (
                                        var y = 0, v = Object.entries(g);
                                        y < v.length;
                                        y++
                                    ) {
                                        var n = v[y],
                            ...
                            (s.prototype.formatTokens = function (i, l) {
                                switch (i) {
                                    case "YY":
                                        return String(this.getFullYear()).slice(
                                            -2
                                        );
                                    case "YYYY":
                ...
                function (x, k, D) {
                    ...
                    var d,
                        ...
                        i =
                            ...
                            function () {
                                for (
                                    var v = 0, n = 0, t = arguments.length;
                                    n < t;
                                    n++
                                )
                                    v += arguments[n].length;
                                var c = Array(v),
                                    u = 0;
                                for (n = 0; n < t; n++)
                                    for (
                    ...
                    var l = D(5),
                        ...
                        y = (function (v) {
                            ...
                            return (
                                s(n, v),
                                (n.prototype.scrollToDate = function (t) {
                                    if (this.options.scrollToDate) {
                                        var c =
                                                ...
                                                e.DateTime
                                                    ...
                                                    : null,
                                            u =
                                                this.options.endDate instanceof
                                                e.DateTime
                                        ...
                                        (t && t !== this.options.element)
                                            ? t &&
                                              ...
                                              (this.calendars[0] = u.clone()))
                                            : (c.setDate(1),
                                              (this.calendars[0] = c.clone()));
                                    }
                                }),
                                (n.prototype.bindEvents = function () {
                                    document.addEventListener(
                                        ...
                                        (this.ui.className = g.litepicker),
                                        ...
                                        this.options.autoRefresh
                                            ? (this.options.element instanceof
                                                  HTMLElement &&
                                              ...
                                              this.options.elementEnd instanceof
                                                  HTMLElement &&
                                        ...
                                        this.options.parentEl
                                            ? this.options.parentEl instanceof
                                              HTMLElement
                                                ? this.options.parentEl.appendChild(
                                                      this.ui
                                                  )
                                                : document
                                                      .querySelector(
                                ...
                                (n.prototype.shouldResetDatePicked =
                                    function () {
                                        return (
                                            this.options.singleMode ||
                                ...
                                (n.prototype.shouldSwapDatePicked =
                                    function () {
                                        return (
                                            this.datePicked.length === 2 &&
                                            this.datePicked[0].getTime() >
                                                this.datePicked[1].getTime()
                                        );
                                    }),
                                ...
                                (n.prototype.showTooltip = function (t, c) {
                                    ...
                                    if (
                                        ...
                                        var p =
                                            this.ui.parentNode.getBoundingClientRect();
                                        (h -= p.top), (m -= p.left);
                                ...
                                (n.prototype.shouldAllowMouseEnter = function (
                                    t
                                ) {
                                    return (
                                        !this.options.singleMode &&
                                        !t.classList.contains(g.isLocked)
                                    );
                                }),
                                ...
                                (n.prototype.onMouseEnter = function (t) {
                                    ...
                                    if (
                                        ...
                                        if (
                                            ...
                                            u.classList.add(g.isEndDate),
                                            h
                                                ? (r &&
                                                      r.classList.add(
                                                          g.isFlipped
                                                      ),
                                                  u.classList.add(g.isFlipped))
                                                : (r &&
                                                      r.classList.remove(
                                                          g.isFlipped
                                                      ),
                                            ...
                                            if (
                                                (typeof this.options
                                                    ...
                                                    "function" &&
                                                    (p =
                                                        this.options.tooltipNumber.call(
                                                            this,
                                                            p
                                                        )),
                                                p > 0)
                                ...
                                (n.prototype.onInput = function (t) {
                                    ...
                                    if (
                                        this.options.elementEnd
                                            ? u instanceof e.DateTime &&
                                              r instanceof e.DateTime &&
                                              u.format(o) ===
                                                  this.options.element.value &&
                                              r.format(o) ===
                                                  this.options.elementEnd.value
                                        ...
                                        var h = u.clone(),
                                            m = 0;
                                        (this.options.elementEnd
                                            ? u.format(o) === t.target.value
                                            : t.target.value.startsWith(
                                                  u.format(o)
                                              )) ||
                                            ((h = r.clone()),
                                            (m =
                ...
                function (x, k, D) {
                    ...
                    Object.defineProperty(k, "__esModule", { value: !0 }),
                        (k.findNestedMonthItem = function (d) {
                            for (
                                var s = d.parentNode.childNodes, i = 0;
                                i < s.length;
                                i += 1
                            )
                        ...
                        (k.dateIsLocked = function (d, s, i) {
                            ...
                            return (
                                s.lockDays.length &&
                                    (l = s.lockDays.filter(function (e) {
                                        return e instanceof Array
                                            ? d.isBetween(
                                                  e[0],
                                                  e[1],
                                                  s.lockDaysInclusivity
                                              )
                                            : e.isSame(d, "day");
                                    }).length),
                                l ||
                                    typeof s.lockDaysFilter != "function" ||
                                    (l = s.lockDaysFilter.call(
                                        this,
                                        d.clone(),
                                        null,
                                        i
                        ...
                        (k.rangeIsLocked = function (d, s) {
                            ...
                            return (
                                s.lockDays.length &&
                                    (i = s.lockDays.filter(function (l) {
                    ...
                    var s = {
                        insert: function (i) {
                            ...
                            window.disableLitepickerStyles ||
                                (e
                                    ? e.nextSibling
                                        ? l.insertBefore(i, e.nextSibling)
                                        : l.appendChild(i)
                                    : l.insertBefore(i, l.firstChild),
                                (window._lastElementInsertedByStyleLoader = i));
                        },
                        singleton: !1,
                    };
                ...
                function (x, k, D) {
                    ...
                    Object.defineProperty(k, "__esModule", { value: !0 });
                    var d = D(1);
                    (k.Litepicker = d.Litepicker),
                        D(11),
                        (window.Litepicker = d.Litepicker),
                        (k.default = d.Litepicker);
                },
                function (x, k, D) {
                    "use strict";
                    var d,
                        ...
                        w = (function (y) {
                            ...
                            return (
                                ...
                                (v.prototype.render = function () {
                                    ...
                                    (c.className = e.containerMonths),
                                        e[
                                            "columns" +
                                                this.options.numberOfColumns
                                        ] &&
                                            (c.classList.remove(
                                                e.columns2,
                                                e.columns3,
                                        ...
                                        this.options.splitView &&
                                            c.classList.add(e.splitView),
                                        this.options.showWeekNumbers &&
                                            c.classList.add(e.showWeekNumbers);
                                    for (
                                        var u = this.calendars[0].clone(),
                                            r = u.getMonth(),
                                            o =
                                                u.getMonth() +
                                                this.options.numberOfMonths,
                                        ...
                                        m.setDate(1),
                                            ...
                                            this.options.splitView
                                                ? (m =
                                                      this.calendars[a].clone())
                                                : m.setMonth(h),
                                            c.appendChild(
                                                this.renderMonth(m, a)
                                            ),
                                            (a += 1);
                                    }
                                    if (
                                        ...
                                        var p = void 0;
                                        typeof this.options.resetButton ==
                                        "function"
                                            ? (p =
                                                  this.options.resetButton.call(
                                                      this
                                                  ))
                                            : (((p =
                                              ...
                                              (p.className = e.resetButton),
                                              (p.innerHTML =
                                                  this.options.buttonText.reset)),
                                            p.addEventListener(
                                                "click",
                                                function (f) {
                                                    f.preventDefault(),
                                ...
                                (v.prototype.renderMonth = function (n, t) {
                                    ...
                                    if (this.options.dropdowns.months) {
                                        ...
                                        m.addEventListener(
                                            ...
                                            function (E) {
                                                ...
                                                if (c.options.splitView) {
                                                    ...
                                                    S =
                                                        g.findNestedMonthItem(
                                                            z
                                                        );
                                                }
                                                c.calendars[S].setMonth(
                                                    Number(O.value)
                                                ),
                                                    c.render(),
                                                    c.emit(
                                        ...
                                        ((b =
                                            document.createElement(
                                                "strong"
                                            )).className = e.monthItemName),
                                            (b.innerHTML = n.toLocaleString(
                                                this.options.lang,
                                                { month: "long" }
                                            )),
                                            h.appendChild(b);
                                    if (this.options.dropdowns.years) {
                                        ...
                                        var T = this.options.dropdowns.minYear,
                                            L = this.options.dropdowns.maxYear
                                    ...
                                    (C.type = "button"),
                                        (C.className = e.buttonPreviousMonth),
                                        (C.innerHTML =
                                            this.options.buttonText.previousMonth);
                                    var F = document.createElement("button");
                                    (F.type = "button"),
                                        (F.className = e.buttonNextMonth),
                                        (F.innerHTML =
                                            this.options.buttonText.nextMonth),
                                        a.appendChild(C),
                                        a.appendChild(h),
                                        a.appendChild(F),
                                        this.options.minDate &&
                                            ...
                                            o.classList.add(e.noPreviousMonth),
                                        this.options.maxDate &&
                                            u.isSameOrAfter(
                                                new l.DateTime(
                                                    this.options.maxDate
                                            ...
                                            o.classList.add(e.noNextMonth);
                                    var j = document.createElement("div");
                                    (j.className = e.monthItemWeekdaysRow),
                                        this.options.showWeekNumbers &&
                                            (j.innerHTML = "<div>W</div>");
                                    for (var R = 1; R <= 7; R += 1) {
                                        var q = 3 + this.options.firstDay + R,
                                            B = document.createElement("div");
                                        (B.innerHTML = this.weekdayName(q)),
                                            (B.title = this.weekdayName(
                                                q,
                                                "long"
                                            )),
                                            j.appendChild(B);
                                    ...
                                    this.options.showWeekNumbers &&
                                        U &&
                                        P.appendChild(this.renderWeekNumber(u));
                                    for (var I = 0; I < U; I += 1) {
                                    ...
                                    for (I = 1; I <= r; I += 1)
                                        u.setDate(I),
                                            this.options.showWeekNumbers &&
                                                ...
                                                P.appendChild(
                                                    this.renderWeekNumber(u)
                                                ),
                                            P.appendChild(this.renderDay(u));
                                    return (
                                        o.appendChild(a),
                                        o.appendChild(j),
                                        o.appendChild(P),
                                        this.emit("render:month", o, n),
                                        o
                                    );
                                }),
                                (v.prototype.renderDay = function (n) {
                                    ...
                                    var t = document.createElement("div");
                                    if (
                                        ((t.className = e.dayItem),
                                        (t.innerHTML = String(n.getDate())),
                                        (t.dataset.time = String(n.getTime())),
                                        n.toDateString() ===
                                            new Date().toDateString() &&
                                            t.classList.add(e.isToday),
                                        this.datePicked.length)
                                    )
                                        this.datePicked[0].toDateString() ===
                                            n.toDateString() &&
                                            (t.classList.add(e.isStartDate),
                                            this.options.singleMode &&
                                                t.classList.add(e.isEndDate)),
                                            this.datePicked.length === 2 &&
                                            ...
                                            this.datePicked.length === 2 &&
                                                ...
                                                t.classList.add(e.isInRange);
                                    else if (this.options.startDate) {
                                        var c = this.options.startDate,
                                            u = this.options.endDate;
                                        c.toDateString() === n.toDateString() &&
                                            (t.classList.add(e.isStartDate),
                                            this.options.singleMode &&
                                                t.classList.add(e.isEndDate)),
                                            u &&
                                    ...
                                    return (
                                        this.options.selectForward &&
                                            this.datePicked.length === 1 &&
                                            n.isBefore(this.datePicked[0]) &&
                                            t.classList.add(e.isLocked),
                                        this.options.selectBackward &&
                                            this.datePicked.length === 1 &&
                                            n.isAfter(this.datePicked[0]) &&
                                            t.classList.add(e.isLocked),
                                        g.dateIsLocked(
                                            n,
                                            this.options,
                                        ...
                                        this.options.highlightedDays.length &&
                                            this.options.highlightedDays.filter(
                                                function (m) {
                                            ...
                                            t.classList.add(e.isHighlighted),
                                        (t.tabIndex = t.classList.contains(
                                            "is-locked"
                                        )
                                            ? -1
                                            : 0),
                                        this.emit("render:day", t, n),
                                        t
                                    );
                                }),
      ...
      `),
                                        ...
                                        if (this.datePicked.length === 1) {
                                            var t = this.datePicked[0].format(
                                                this.options.format,
                                                this.options.lang
                                            );
                                            n.querySelector(
                                        ...
                                        var c = this.datePicked[1].format(
                                            this.options.format,
                                            this.options.lang
                                        );
                                        n.querySelector(
                                ...
                                (v.prototype.renderTooltip = function () {
                                    var n = document.createElement("div");
                                    return (
                                        (n.className = e.containerTooltip), n
                                    );
                                }),
                                (v.prototype.weekdayName = function (n, t) {
                                    return (
                                        ...
                                        new Date(
                                            ...
                                            0,
                                            0
                                        ).toLocaleString(this.options.lang, {
                                            weekday: t,
                                        })
                                    );
                                }),
                        ...
                        i =
                            ...
                            function () {
                                return (i =
                                    ...
                                    function (y) {
                                        for (
                                            var v, n = 1, t = arguments.length;
                                            n < t;
                                            n++
                                        )
                                            for (var c in (v = arguments[n]))
        ...
        <path d="M13 3c-4.97 0-9 4.03-9 9H1l3.89 3.89.07.14L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42C8.27 19.99 10.51 21 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9zm-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8H12z"/>
                                    ...
                                    Object.keys(t.options).forEach(function (
                                        T
                                    ) {
                                        (t.options[T] !== "true" &&
                                            t.options[T] !== "false") ||
                                ...
                                var c = i(
                                        i({}, t.options.dropdowns),
                                        n.dropdowns
                                    ),
                                    u = i(
                                        i({}, t.options.buttonText),
                                        n.buttonText
                                    ),
                                    r = i(
                                        i({}, t.options.tooltipText),
                                        n.tooltipText
                                    );
                                (t.options = i(i({}, t.options), n)),
                                    (t.options.dropdowns = i({}, c)),
                                    (t.options.buttonText = i({}, u)),
                                    (t.options.tooltipText = i({}, r)),
                                    t.options.elementEnd ||
                                        (t.options.allowRepick = !1),
                                    t.options.lockDays.length &&
                                        (t.options.lockDays =
                                            e.DateTime.convertArray(
                                                t.options.lockDays,
                                                t.options.lockDaysFormat
                                            )),
                                    t.options.highlightedDays.length &&
                                        (t.options.highlightedDays =
                                            e.DateTime.convertArray(
                                                t.options.highlightedDays,
                                                t.options.highlightedDaysFormat
                                            ));
                                var o = t.parseInput(),
                                    a = o[0],
                                    h = o[1];
                                t.options.startDate &&
                                    (t.options.singleMode ||
                                        t.options.endDate) &&
                                    (a = new e.DateTime(
                                        t.options.startDate,
                                        t.options.format,
                                    ...
                                    a instanceof e.DateTime &&
                                        !isNaN(a.getTime()) &&
                                        (t.options.startDate = a),
                                    t.options.startDate &&
                                        h instanceof e.DateTime &&
                                        !isNaN(h.getTime()) &&
                                        (t.options.endDate = h),
                                    !t.options.singleMode ||
                                        t.options.startDate instanceof
                                            e.DateTime ||
                                        (t.options.startDate = null),
                                    t.options.singleMode ||
                                        (t.options.startDate instanceof
                                            e.DateTime &&
                                            t.options.endDate instanceof
                                                e.DateTime) ||
                                        ((t.options.startDate = null),
                                        (t.options.endDate = null));
                                for (
                                    var m = 0;
                                    m < t.options.numberOfMonths;
                                    m += 1
                                ) {
                                    var p =
                                        t.options.startDate instanceof
                                        e.DateTime
                                            ? t.options.startDate.clone()
                                            : new e.DateTime();
                                    if (
                                        !t.options.startDate &&
                                        (m === 0 || t.options.splitView)
                                    ) {
                                ...
                                if (t.options.showTooltip)
                                    if (t.options.tooltipPluralSelector)
                                        t.pluralSelector =
                                            t.options.tooltipPluralSelector;
                                    else
                                        try {
                                            var _ = new Intl.PluralRules(
                                                t.options.lang
                                            );
                            ...
                            return (
                                ...
                                (v.prototype.init = function () {
                                    ...
                                    this.options.plugins &&
                                        ...
                                        this.options.plugins.forEach(function (
                                            t
                                        ) {
                                            g.Litepicker.prototype.hasOwnProperty(
                                                t
                                            )
                                                ? g.Litepicker.prototype[
                                                      t
                                                  ].init.call(n, n)
                                                : console.warn(
                                                      "Litepicker: plugin \xAB" +
                                                          t +
                                                          "\xBB not found."
                                                  );
                                        });
                                ...
                                (v.prototype.parseInput = function () {
                                    var n = this.options.delimiter,
                                        ...
                                        c =
                                            this.options.element instanceof
                                            HTMLInputElement
                                                ? this.options.element.value.split(
                                                      n
                                                  )
                                                : [];
                                    if (this.options.elementEnd) {
                                        ...
                                        this.options.element instanceof
                                            HTMLInputElement &&
                                        t.test(this.options.element.value) &&
                                        c.length &&
                                        c.length % 2 == 0
                                    ) {
                                        var u = c
                ...
                function (x, k, D) {
                    ...
                    function y(r, o, a, h) {
                        ...
                        if (
                            ((p = r._events) === void 0
                                ? ((p = r._events = Object.create(null)),
                                  (r._eventsCount = 0))
                    ...
                    function u(r, o) {
                        for (var a = new Array(o), h = 0; h < o; ++h)
                            a[h] = r[h];
                        return a;
                    }
                    Object.defineProperty(e, "defaultMaxListeners", {
                        ...
                        (e.prototype.prependListener = function (r, o) {
                            return y(this, r, o, !0);
                        }),
                        ...
                        (e.prototype.removeListener = function (r, o) {
                            ...
                            if (a === o || a.listener === o)
                                ...
                                m === 0
                                    ...
                                    a.length === 1 && (h[r] = a[0]),
                                    h.removeListener !== void 0 &&
                                        this.emit("removeListener", r, f || o);
                            }
                            return this;
                        }),
                        ...
                        (e.prototype.removeAllListeners = function (r) {
                            ...
                            if (arguments.length === 0) {
                                ...
                                for (h = 0; h < p.length; ++h)
                                    (m = p[h]) !== "removeListener" &&
                                        this.removeAllListeners(m);
                                return (
                            ...
                            if (typeof (o = a[r]) == "function")
                                this.removeListener(r, o);
                            else if (o !== void 0)
                                for (h = o.length - 1; h >= 0; h--)
                                    this.removeListener(r, o[h]);
                            return this;
                        }),
                    ...
                    function e(o, a) {
                        for (var h = [], m = {}, p = 0; p < o.length; p++) {
                            var f = o[p],
                                ...
                                M = { css: f[1], media: f[2], sourceMap: f[3] };
                            m[b]
                                ? m[b].parts.push(M)
                                : h.push((m[b] = { id: b, parts: [M] }));
                        }
                        return h;
                    }
                    function g(o, a) {
                        for (var h = 0; h < o.length; h++) {
                            var m = o[h],
                                ...
                                f = 0;
                            if (p) {
                                for (p.refs++; f < p.parts.length; f++)
                                    p.parts[f](m.parts[f]);
                                for (; f < m.parts.length; f++)
                                    p.parts.push(r(m.parts[f], a));
                            } else {
                                for (var b = []; f < m.parts.length; f++)
                                    b.push(r(m.parts[f], a));
                                s[m.id] = { id: m.id, refs: 1, parts: b };
                            }
                        }
                    }
                    function w(o) {
                        ...
                        if (
                            (Object.keys(o.attributes).forEach(function (p) {
                    ...
                    function n(o, a, h, m) {
                        ...
                        if (o.styleSheet) o.styleSheet.cssText = v(a, p);
                            ...
                            var f = document.createTextNode(p),
                                b = o.childNodes;
                            b[a] && o.removeChild(b[a]),
                                b.length
                                    ? o.insertBefore(f, b[a])
                                    : o.appendChild(f);
                        }
                    }
                    function t(o, a, h) {
                ...
                function (x, k, D) {
                    ...
                    var d =
                        ...
                        function () {
                            return (d =
                                ...
                                function (e) {
                                    for (
                                        var g, w = 1, y = arguments.length;
                                        w < y;
                                        w++
                                    )
                                        for (var v in (g = arguments[w]))
                                            Object.prototype.hasOwnProperty.call(
                                                g,
                                                v
                                            ) && (e[v] = g[v]);
                    ...
                    (i.Litepicker.prototype.show = function (e) {
                        ...
                        if (((this.triggerElement = g), !this.isShowning())) {
                            ...
                            (this.ui.style.top = w.top + "px"),
                                (this.ui.style.left = w.left + "px"),
                        ...
                        (i.Litepicker.prototype.setDate = function (e, g) {
                            g === void 0 && (g = !1);
                            var w = new s.DateTime(
                                e,
                                this.options.format,
                                this.options.lang
                            );
                            l.dateIsLocked(w, this.options, [w]) && !g
                                ? this.emit("error:date", w)
                                : (this.setStartDate(e),
                        ...
                        (i.Litepicker.prototype.setDateRange = function (
                            e,
                            g,
                            w
                        ) {
                            ...
                            (this.options.disallowLockDaysInRange
                                ? l.rangeIsLocked([y, v], this.options)
                                : l.dateIsLocked(y, this.options, [y, v]) ||
                                  l.dateIsLocked(v, this.options, [y, v])) && !w
                                ? this.emit("error:range", [y, v])
                                : (this.setStartDate(y),
                                  this.setEndDate(v),
                                  this.options.inlineMode && this.render(),
                                  this.updateInput(),
                        ...
                        (i.Litepicker.prototype.setHighlightedDays = function (
                            e
                        ) {
                            (this.options.highlightedDays =
                                s.DateTime.convertArray(
                                    e,
                        ...
                        (i.Litepicker.prototype.setOptions = function (e) {
                            delete e.element,
                                ...
                                delete e.parentEl,
                                e.startDate &&
                                    (e.startDate = new s.DateTime(
                                        e.startDate,
                                        this.options.format,
                                        this.options.lang
                                    )),
                                e.endDate &&
                                    (e.endDate = new s.DateTime(
                                        e.endDate,
                                        this.options.format,
                                        this.options.lang
                                    ));
                            var g = d(
                                    d({}, this.options.dropdowns),
                                    e.dropdowns
                                ),
                                w = d(
                                    d({}, this.options.buttonText),
                                    e.buttonText
                                ),
                                y = d(
                                    d({}, this.options.tooltipText),
                                    e.tooltipText
                                );
                            (this.options = d(d({}, this.options), e)),
                                (this.options.dropdowns = d({}, g)),
                                (this.options.buttonText = d({}, w)),
                                (this.options.tooltipText = d({}, y)),
                                !this.options.singleMode ||
                                    this.options.startDate instanceof
                                        s.DateTime ||
