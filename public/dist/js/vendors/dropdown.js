function initializeDropdown() {
    ...
    (function() {
        ...
        async function d() {
            $(".dropdown-menu").each(async function() {
                if ($(this).attr("id") !== void 0 && $('[data-dropdown-replacer="' + $(this).attr("id") + '"]').length && $(this).data("dropdown-programmatically") === void 0) {
                    ...
                    $(t).parent()[0].dispatchEvent(n);
                    await new Promise(resolve => setTimeout(resolve, 200)); // Await the setTimeout
                    
                    $('[data-dropdown-replacer="' + e + '"]').replaceWith(this);
                    ...
                    await d(); // Recursively call `d` if necessary
                }
            });
        }
        ...
        function s(e) {
            if ($(e).find(".dropdown-menu").length) {
                $(e).find(".dropdown-menu").attr("data-dropdown-programmatically", "initiate");
            } else {
        ...
        $("body").on("click", async function(e) {
            ...
            !$(t).length && !$(o).length || $(n).length && !$(a).length || i == "dropdown" ? d() : $(o).length || await r(t);
        });
